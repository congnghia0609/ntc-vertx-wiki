...
//    }
    ...
    //<editor-fold defaultstate="collapsed" desc="Code Step7">
    @Override
    public void start(Promise<Void> promise) throws Exception {
...
//    @Override
//    public void start(Promise<Void> promise) throws Exception {
//        Single<String> dbVerticleDeployment = vertx.rxDeployVerticle("io.vertx.starter.database.WikiDatabaseVerticle");
//
...
//                })
//                .flatMap(id -> vertx.rxDeployVerticle("io.vertx.starter.http.AuthInitializerVerticle"))
//                .subscribe(id -> promise.complete(), promise::fail);
//    }
    //</editor-fold>
    
    //<editor-fold defaultstate="collapsed" desc="Code Step1 + Step2: WebServer Handle Simple">
